...
# Health-check targets: must match risk_profile._allocation_from_score.
# conservative: (10, 60, 30)  moderate: (60, 30, 10)  aggressive: (80, 15, 5)
_TARGETS = {
    RiskLevel.CONSERVATIVE: (10, 60, 30),
    RiskLevel.MODERATE: (60, 30, 10),
    RiskLevel.AGGRESSIVE: (80, 15, 5),
}
